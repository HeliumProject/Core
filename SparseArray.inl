...
void Helium::SparseArray< T, Allocator >::Remove( size_t index )
{
    ...
    if( index == m_size - 1 )
    {
        ...
        // been triggered.
        HELIUM_BREAK_MSG( "SparseArray::Remove(): Failed to find a used array slot, although at least one should exist." );
...
size_t Helium::SparseArray< T, Allocator >::AllocateSlot()
{
    ...
    if( m_usedSize != size )
    {
        ...
        HELIUM_BREAK_MSG( "SparseArray::AllocateSlot(): Failed to find an unused array slot, although at least one should exist." );
    }
