...
namespace Helium
{
	...
	class HELIUM_PERSIST_API XMLElement
	{
	public:
	...
	class HELIUM_PERSIST_API XMLDocument
	{
	public:
		class Iterator
		{
		...
		bool Parse( const void* buffer, uint32_t length, bool finalize );
...
#include "Persist/XMLDocument.inl"