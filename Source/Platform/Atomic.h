...
namespace Helium
{
	...
	HELIUM_PLATFORM_API int32_t AtomicExchange( int32_t volatile & rAtomic, int32_t value );
	...
	///
	/// @return  Original integer value upon swapping.
	HELIUM_PLATFORM_API int32_t AtomicExchangeAcquire( int32_t volatile & rAtomic, int32_t value );
	...
	///
	/// @return  Original integer value upon swapping.
	HELIUM_PLATFORM_API int32_t AtomicExchangeRelease( int32_t volatile & rAtomic, int32_t value );
	...
	///
	/// @return  Original integer value upon swapping.
	HELIUM_PLATFORM_API int32_t AtomicExchangeUnsafe( int32_t volatile & rAtomic, int32_t value );
	...
	HELIUM_PLATFORM_API int32_t AtomicCompareExchange( int32_t volatile & rAtomic, int32_t value, int32_t compare );
	...
	/// @return  Original integer value when the comparison occurred.  If this is the same as @c compare, the integer's
	///          value will have been updated to match @c value, otherwise it will have been left unchanged.
	HELIUM_PLATFORM_API int32_t AtomicCompareExchangeAcquire( int32_t volatile & rAtomic, int32_t value, int32_t compare );
	...
	/// @return  Original integer value when the comparison occurred.  If this is the same as @c compare, the integer's
	///          value will have been updated to match @c value, otherwise it will have been left unchanged.
	HELIUM_PLATFORM_API int32_t AtomicCompareExchangeRelease( int32_t volatile & rAtomic, int32_t value, int32_t compare );
	...
	/// @return  Original integer value when the comparison occurred.  If this is the same as @c compare, the integer's
	///          value will have been updated to match @c value, otherwise it will have been left unchanged.
	HELIUM_PLATFORM_API int32_t AtomicCompareExchangeUnsafe( int32_t volatile & rAtomic, int32_t value, int32_t compare );
	...
	HELIUM_PLATFORM_API int32_t AtomicIncrement( int32_t volatile & rAtomic );
	...
	///
	/// @return  New value after incrementing.
	HELIUM_PLATFORM_API int32_t AtomicIncrementAcquire( int32_t volatile & rAtomic );
	...
	///
	/// @return  New value after incrementing.
	HELIUM_PLATFORM_API int32_t AtomicIncrementRelease( int32_t volatile & rAtomic );
	...
	///
	/// @return  New value after incrementing.
	HELIUM_PLATFORM_API int32_t AtomicIncrementUnsafe( int32_t volatile & rAtomic );
	...
	HELIUM_PLATFORM_API int32_t AtomicDecrement( int32_t volatile & rAtomic );
	...
	///
	/// @return  New value after decrementing.
	HELIUM_PLATFORM_API int32_t AtomicDecrementAcquire( int32_t volatile & rAtomic );
	...
	///
	/// @return  New value after decrementing.
	HELIUM_PLATFORM_API int32_t AtomicDecrementRelease( int32_t volatile & rAtomic );
	...
	///
	/// @return  New value after decrementing.
	HELIUM_PLATFORM_API int32_t AtomicDecrementUnsafe( int32_t volatile & rAtomic );
	...
	HELIUM_PLATFORM_API int32_t AtomicAdd( int32_t volatile & rAtomic, int32_t value );
	...
	///
	/// @return  Original integer value prior to updating.
	HELIUM_PLATFORM_API int32_t AtomicAddAcquire( int32_t volatile & rAtomic, int32_t value );
	...
	///
	/// @return  Original integer value prior to updating.
	HELIUM_PLATFORM_API int32_t AtomicAddRelease( int32_t volatile & rAtomic, int32_t value );
	...
	///
	/// @return  Original integer value prior to updating.
	HELIUM_PLATFORM_API int32_t AtomicAddUnsafe( int32_t volatile & rAtomic, int32_t value );
	...
	///
	/// @return  Original integer value prior to updating.
	HELIUM_PLATFORM_API int32_t AtomicSubtract( int32_t volatile & rAtomic, int32_t value );
	...
	///
	/// @return  Original integer value prior to updating.
	HELIUM_PLATFORM_API int32_t AtomicSubtractAcquire( int32_t volatile & rAtomic, int32_t value );
	...
	///
	/// @return  Original integer value prior to updating.
	HELIUM_PLATFORM_API int32_t AtomicSubtractRelease( int32_t volatile & rAtomic, int32_t value );
	...
	///
	/// @return  Original integer value prior to updating.
	HELIUM_PLATFORM_API int32_t AtomicSubtractUnsafe( int32_t volatile & rAtomic, int32_t value );
	...
	///
	/// @return  Original integer value prior to updating.
	HELIUM_PLATFORM_API int32_t AtomicAnd( int32_t volatile & rAtomic, int32_t value );
	...
	///
	/// @return  Original integer value prior to updating.
	HELIUM_PLATFORM_API int32_t AtomicAndAcquire( int32_t volatile & rAtomic, int32_t value );
	...
	///
	/// @return  Original integer value prior to updating.
	HELIUM_PLATFORM_API int32_t AtomicAndRelease( int32_t volatile & rAtomic, int32_t value );
	...
	///
	/// @return  Original integer value prior to updating.
	HELIUM_PLATFORM_API int32_t AtomicAndUnsafe( int32_t volatile & rAtomic, int32_t value );
	...
	///
	/// @return  Original integer value prior to updating.
	HELIUM_PLATFORM_API int32_t AtomicOr( int32_t volatile & rAtomic, int32_t value );
	...
	///
	/// @return  Original integer value prior to updating.
	HELIUM_PLATFORM_API int32_t AtomicOrAcquire( int32_t volatile & rAtomic, int32_t value );
	...
	///
	/// @return  Original integer value prior to updating.
	HELIUM_PLATFORM_API int32_t AtomicOrRelease( int32_t volatile & rAtomic, int32_t value );
	...
	///
	/// @return  Original integer value prior to updating.
	HELIUM_PLATFORM_API int32_t AtomicOrUnsafe( int32_t volatile & rAtomic, int32_t value );
	...
	///
	/// @return  Original integer value prior to updating.
	HELIUM_PLATFORM_API int32_t AtomicXor( int32_t volatile & rAtomic, int32_t value );
	...
	///
	/// @return  Original integer value prior to updating.
	HELIUM_PLATFORM_API int32_t AtomicXorAcquire( int32_t volatile & rAtomic, int32_t value );
	...
	///
	/// @return  Original integer value prior to updating.
	HELIUM_PLATFORM_API int32_t AtomicXorRelease( int32_t volatile & rAtomic, int32_t value );
	...
	///
	/// @return  Original integer value prior to updating.
	HELIUM_PLATFORM_API int32_t AtomicXorUnsafe( int32_t volatile & rAtomic, int32_t value );
	...
	HELIUM_PLATFORM_API void* AtomicExchangePointer( void* volatile & rAtomic, void* value );
	...
	///
	/// @return  Original pointer value upon swapping.
	HELIUM_PLATFORM_API void* AtomicExchangePointerAcquire( void* volatile & rAtomic, void* value );
	...
	///
	/// @return  Original pointer value upon swapping.
	HELIUM_PLATFORM_API void* AtomicExchangePointerRelease( void* volatile & rAtomic, void* value );
	...
	///
	/// @return  Original pointer value upon swapping.
	HELIUM_PLATFORM_API void* AtomicExchangePointerUnsafe( void* volatile & rAtomic, void* value );
	...
	///          value will have been updated to match @c value, otherwise it will have been left unchanged.
	HELIUM_PLATFORM_API void* AtomicCompareExchangePointer( void* volatile & rAtomic, void* value, void* compare );
	...
	/// @return  Original pointer value when the comparison occurred.  If this is the same as @c compare, the pointer's
	///          value will have been updated to match @c value, otherwise it will have been left unchanged.
	HELIUM_PLATFORM_API void* AtomicCompareExchangePointerAcquire( void* volatile & rAtomic, void* value, void* compare );
	...
	/// @return  Original pointer value when the comparison occurred.  If this is the same as @c compare, the pointer's
	///          value will have been updated to match @c value, otherwise it will have been left unchanged.
	HELIUM_PLATFORM_API void* AtomicCompareExchangePointerRelease( void* volatile & rAtomic, void* value, void* compare );
	...
	/// @return  Original pointer value when the comparison occurred.  If this is the same as @c compare, the pointer's
	///          value will have been updated to match @c value, otherwise it will have been left unchanged.
	HELIUM_PLATFORM_API void* AtomicCompareExchangePointerUnsafe( void* volatile & rAtomic, void* value, void* compare );
