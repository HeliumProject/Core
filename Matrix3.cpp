...
REFLECT_DEFINE_BASE_STRUCTURE( Helium::Matrix3 );
...
void Matrix3::PopulateStructure( Reflect::Structure& comp )
{
	comp.AddField( &Matrix3::x, "x" );
	comp.AddField( &Matrix3::y, "y" );
	comp.AddField( &Matrix3::z, "z" );
}
